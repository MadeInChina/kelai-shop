(function(HC, $, undefined) {
    ...
    HC.showNotificationSuccess = function (notification, delay) {
        HC.showNotification('webTemplates.account.actionMsg.success', notification, delay);
    };
    ...
    function initProductColorOptionsEvent() {
        $('.js-productOption').bind('click',function () {
            $(this).addClass('active');
            $('.js-productOption').removeClass('active').find('i').hide();
            $(this).find('i').show();
        });
    };
    initProductColorOptionsEvent();
