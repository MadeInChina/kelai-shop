...
(function(Checkout, $, undefined) {
    ...
    function loadWxPayQrcode() {
        //$('#wxpayQrcodeImg').attr('src','/wxpay/qrcode');
        ...
        $.ajax({
            ...
            success:function (response) {
                if (response.orderStatus === 'PAID') {
                    ...
                    //window.location.href = '/wxpay/success?orderNumber=' + response.orderNumber + '&paymentType=wxpay';
                }
            },
            error:function () {
           ...
           /* beforeSend: function(request) {
            ...
            success:function (response) {
                if(response.status === 'success'){
                    //wxpay(appid,timeStamp,nonceStr,package,paySign,orderId)
