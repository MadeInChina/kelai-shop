...
@Service("blAlipayTransactionService")
public class AlipayTransactionServiceImpl extends AbstractPaymentGatewayTransactionService implements PaymentGatewayTransactionService {
    @Override
