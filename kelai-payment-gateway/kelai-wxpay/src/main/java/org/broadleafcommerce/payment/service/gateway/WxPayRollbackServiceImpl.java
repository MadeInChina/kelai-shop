...
@Service("blWxPayRollbackService")
public class WxPayRollbackServiceImpl extends AbstractPaymentGatewayRollbackService implements PaymentGatewayRollbackService {
    @Override
