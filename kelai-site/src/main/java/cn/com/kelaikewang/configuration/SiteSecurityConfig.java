...
import cn.com.kelaikewang.security.ZaoJiCMSAuthenticationFailureHandler;
import cn.com.kelaikewang.security.ZaoJiCMSAuthenticationSuccessHandler;
...
public class SiteSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public static class DependencyConfiguration {
        ...
        protected AuthenticationFailureHandler blAuthenticationFailureHandler(@Qualifier("blAuthenticationFailureRedirectStrategy") RedirectStrategy redirectStrategy) {
            BroadleafAuthenticationFailureHandler response = new ZaoJiCMSAuthenticationFailureHandler("/login?error=true");
        ...
        protected AuthenticationSuccessHandler blAuthenticationSuccessHandler(@Qualifier("blAuthenticationSuccessRedirectStrategy") RedirectStrategy redirectStrategy,
                                                                              @Qualifier("blCustomerService") ZaoJiCMSCustomerService nsCustomerService) {
            ZaoJiCMSAuthenticationSuccessHandler handler = new ZaoJiCMSAuthenticationSuccessHandler();
            handler.setNsCustomerService(nsCustomerService);
        ...
        protected Filter blCsrfFilter() {
            ...
            //<value>/wxpay/**</value>
            //<value>/alipay/**</value>
            excludedRequestPatterns.add("/wxpay/notify");
            excludedRequestPatterns.add("/wxpay/refundNotify");
            excludedRequestPatterns.add("/alipay/notify");
            //excludedRequestPatterns.add("/account/upload");
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
            ...
            .formLogin()
                ...
                .and()
            .authorizeRequests()
                .antMatchers("/account/wishlist/**", "/account/**","/article/*/comment","/article/*/comment/*/report")
