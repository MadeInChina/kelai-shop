...
package cn.com.kelaikewang.controller.cart;
...
public class CartController extends BroadleafCartController {
    ...
    @RequestMapping(value = "saveOrderItemsShippingPricingRule",method = RequestMethod.POST)
    @ResponseBody
    public ResponseDTO save(@RequestBody List<OrderItemShippingPricingRuleDTO> dtos){
        nextShopOrderItemService.saveOrderItemsShippingPricingRule(dtos);
        return ResponseDTO.success("操作成功");
    }
    @RequestMapping(value = "saveOrderItemShippingPricingRule",method = RequestMethod.POST)
    @ResponseBody
    public ResponseDTO save(@RequestBody OrderItemShippingPricingRuleDTO dto){
        nextShopOrderItemService.saveOrderItemShippingPricingRule(dto);
        return ResponseDTO.success("操作成功");
    }
    @Override
    @RequestMapping("")
    ...
    public String updateQuantity(HttpServletRequest request, HttpServletResponse response, Model model, RedirectAttributes redirectAttributes,
            @ModelAttribute("addToCartItem") OrderItemRequestDTO addToCartItem) throws IOException, PricingException, UpdateCartException, RemoveFromCartException {
        try {
